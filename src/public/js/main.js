...
// Application globals
const MS_URL = "http://localhost:3000";
const MS_TOKEN = "mark-access-token";

// Session
const accessToken = localStorage.getItem(MS_TOKEN);

// Functions

/**
 * Logs response errors and gives an alert to the user. Call after most (every?)
 * axios api call.
 * 
 * @param {axios error response} error
 */
...
/**
 * A lightweight version of the SHA256 hash
 * 
 * Source: https://github.com/geraintluff/sha256
 * 
 * @param {String} b    The String to hash
 */
...
// Do we need this nonsense? TODO: evaluate necessity
if (!accessToken) {
